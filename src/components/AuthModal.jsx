  ...
  return (
    ...
    >  //visuals and buttons
      ...
      <div
        ...
        className="relative w-full max-w-md overflow-hidden rounded-2xl border border-white/[0.1] bg-[#0E141B]/95 p-8 shadow-2xl backdrop-blur-xl"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 flex h-7 w-7 items-center justify-center rounded-full border border-white/10 text-slate-400 transition hover:border-white/30 hover:text-white cursor-pointer"
        >
          ✕
        </button>
